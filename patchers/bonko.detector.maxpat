{
  "patcher": {
    ...
    "boxes": [
      {"box": {"id": "obj-19", "maxclass": "panel", "mode": 0, "rounded": 8, "ignoreclick": 1, "bgfillcolor": {"angle": 270.0, "autogradient": 0, "color": [0.5, 0.5, 0.5, 0.14], "proportion": 0.39, "type": "color"}, "numinlets": 1, "numoutlets": 0, "patching_rect": [600.0, 20.0, 100.0, 100.0], "presentation": 1, "presentation_rect": [1.0, 1.0, 118.0, 159.0]}},
      ...
      {"box": {"id": "obj-15", "maxclass": "live.dial", "varname": "retrig", "parameter_enable": 1, "numinlets": 1, "numoutlets": 2, "outlettype": ["", "float"], "patching_rect": [460.0, 60.0, 44.0, 48.0], "presentation": 1, "presentation_rect": [54.0, 112.0, 44.0, 48.0], "saved_attribute_attributes": {"valueof": {"parameter_longname": "Retrig", "parameter_shortname": "Retrig", "parameter_type": 0, "parameter_unitstyle": 2, "parameter_range": [20.0, 500.0], "parameter_initial_enable": 1, "parameter_initial": [60.0]}}}},
      {"box": {"id": "obj-16", "maxclass": "meter~", "numinlets": 1, "numoutlets": 1, "outlettype": ["float"], "patching_rect": [200.0, 170.0, 12.0, 80.0], "presentation": 1, "presentation_rect": [8.0, 26.0, 12.0, 126.0]}},
      {"box": {"id": "obj-17", "maxclass": "button", "numinlets": 1, "numoutlets": 1, "outlettype": ["bang"], "patching_rect": [130.0, 410.0, 20.0, 20.0], "presentation": 1, "presentation_rect": [98.0, 4.0, 16.0, 16.0]}},
      {"box": {"id": "obj-18", "maxclass": "comment", "text": "BONKO DETECT", "numinlets": 1, "numoutlets": 0, "fontsize": 10.0, "patching_rect": [300.0, 20.0, 120.0, 20.0], "presentation": 1, "presentation_rect": [6.0, 4.0, 88.0, 16.0]}}
    ],
    "lines": [
