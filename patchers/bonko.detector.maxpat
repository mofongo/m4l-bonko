{
  "patcher": {
    ...
    "boxes": [
      ...
      {"box": {"id": "obj-15", "maxclass": "live.dial", "varname": "retrig", "parameter_enable": 1, "numinlets": 1, "numoutlets": 2, "outlettype": ["", "float"], "patching_rect": [460.0, 60.0, 44.0, 48.0], "presentation": 1, "presentation_rect": [39.7, 103.5, 44.0, 48.0], "saved_attribute_attributes": {"valueof": {"parameter_longname": "Retrig", "parameter_shortname": "Retrig", "parameter_type": 0, "parameter_unitstyle": 2, "parameter_range": [20.0, 500.0], "parameter_initial_enable": 1, "parameter_initial": [60.0]}}}},
      {"box": {"id": "obj-16", "maxclass": "meter~", "numinlets": 1, "numoutlets": 1, "outlettype": ["float"], "patching_rect": [200.0, 170.0, 12.0, 80.0], "presentation": 1, "presentation_rect": [4.0, 25.3, 12.0, 126.0]}},
      {"box": {"id": "obj-17", "maxclass": "button", "numinlets": 1, "numoutlets": 1, "outlettype": ["bang"], "patching_rect": [130.0, 410.0, 20.0, 20.0], "presentation": 1, "presentation_rect": [93.0, 6.3, 16.0, 16.0]}},
      {"box": {"id": "obj-18", "maxclass": "comment", "text": "TRANSIENT", "numinlets": 1, "numoutlets": 0, "fontsize": 10.0, "patching_rect": [300.0, 20.0, 120.0, 20.0], "presentation": 1, "presentation_rect": [26.9, 5.2, 88.0, 18.0]}}
    ],
    "lines": [
