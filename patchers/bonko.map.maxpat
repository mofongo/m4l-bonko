{
  "patcher": {
    ...
    "boxes": [
      ...
      {"box": {"id": "obj-5", "maxclass": "message", "text": "Map a parameter", "numinlets": 2, "numoutlets": 1, "outlettype": [""], "patching_rect": [420.0, 300.0, 150.0, 22.0], "presentation": 1, "presentation_rect": [42.0, 4.0, 86.0, 18.0]}},
